...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/09/14 12:43:28 by tvachera          #+#    #+#             */
/*   Updated: 2020/09/14 13:52:12 by tvachera         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
short	check_base(char *base, int *base_x)
{
	int	i;
	int	j;
...
char	*check_nbr(char *nbr, char *base, short *is_positive)
{
	unsigned int	i;
...
int		ft_atoi_base(char *str, char *base, int base_x)
{
	...
	result = 0;
	nbr_size = -1;
	str = check_nbr(str, base, &is_positive);
	if (!str)
		return (FALSE);
